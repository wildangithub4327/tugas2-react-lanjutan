...
export default function AdminLayout() {
  ...
  // State untuk mengontrol buka/tutup dropdown secara manual
        ...
        <nav className="bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
          <div className="flex flex-wrap justify-between items-center">
            <div className="flex justify-start items-center">
              <button
                className="p-2 mr-2 text-gray-600 rounded-lg cursor-pointer md:hidden hover:text-gray-900 hover:bg-gray-100 dark:focus:bg-gray-700 focus:ring-2 focus:ring-gray-100 dark:focus:ring-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
              >
            ...
            <div className="flex items-center lg:order-2 relative">
              {/* Tombol Foto Profil - Ditambahkan onClick untuk toggle state */}
              <button
                type="button"
              ...
              {/* Dropdown Menu - Menggunakan conditional rendering berdasarkan state isDropdownOpen */}
              {isDropdownOpen && (
                <div
                  className="absolute right-0 top-9 z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
                  style={{ display: 'block' }} 
                >
                  <div className="py-3 px-4">
                    <span className="block text-sm font-semibold text-gray-900 dark:text-white">Administrator</span>
                    <span className="block text-sm text-gray-900 truncate dark:text-white">admin@booksales.com</span>
                  </div>
                  <ul className="py-1 text-gray-700 dark:text-gray-300">
                    <li>
                      <a
                        ...
                        className="block py-2 px-4 text-sm text-red-600 font-medium hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                      >
                        Sign out
                      </a>
                    </li>
